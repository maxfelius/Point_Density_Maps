...
#creating the data object
dataset_obj = CreateResolutionMap.create_resolution_map(datasets,cell_radius,'combined_dataset_s1_RSAT.csv')

#start creating the map
data = dataset_obj.start()

#save the dataset
data.to_csv('Resolution_Map_Combined_Dataset_S1RSAT_200x200.csv')
